setwd("D:/Desktop/Projects/wastewater/Figure/Figure1/Alpha")
`%notin%` <- Negate(`%in%`)
library(ggplot2)
library(dplyr)
library(stringr)
...
ggsave("alpha_microbiome.pdf",alpha_final,device = "pdf",width = 15,height = 10)
